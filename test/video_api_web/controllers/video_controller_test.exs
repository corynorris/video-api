defmodule VideoApiWeb.VideoControllerTest do
  use VideoApiWeb.ConnCase

  alias VideoApi.Videos

  @create_attrs %{content_type: "some content_type", description: "some description", filename: "some filename", path: "some path", title: "some title"}
